...
public class ChatAdapter extends BaseAdapter {
    ...
    public ChatAdapter(Activity context, List<MessengerItem> messengerItems) {
        this.context = context;
        this.messengerItems = messengerItems;
    }
    ...
    public void add(MessengerItem message) {
        messengerItems.add(message);
    }

    public void add(List<MessengerItem> messages) {
        messengerItems.addAll(messages);
    }
